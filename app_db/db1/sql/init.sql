...
CREATE TABLE total.tester
(
    ID   INT,
    NAME VARCHAR(128)
);

INSERT INTO total.tester(ID, NAME)
VALUES (1, 'aa1');
INSERT INTO total.tester(ID, NAME)
VALUES (2, 'bb2');
INSERT INTO total.tester(ID, NAME)
...
alter table band.members
    add constraint FK8j5lgp8y2l9g13b1yv0lviaib
        foreign key (band_id)
            references band.bands (id);
...
values ('admin', 0, 'admin', 1, 'testestset')